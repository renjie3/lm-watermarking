...
RUN_NAME=opt_2.7b_semantic_json_100_use_sample
LLAMA_PATH=No
...
CUDA_VISIBLE_DEVICES=7 HF_HOME="/egr/research-dselab/renjie3/renjie/LLM/cache" python generation_pipeline.py \
...
# HF_HOME="/egr/research-dselab/renjie3/renjie/LLM/cache" OPENAI_API_KEY=`cat ../openai_key.txt` python attack_pipeline.py \
#     --attack_method=gpt \
...
# CUDA_VISIBLE_DEVICES=1 HF_HOME="/egr/research-dselab/renjie3/renjie/LLM/cache"  python evaluation_pipeline.py \
